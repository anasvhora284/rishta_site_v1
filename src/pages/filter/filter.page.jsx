...
const Filter = () => {
               ...
               try {
                    ...
                    if (excelData && excelData.length > 0) {
                         ...
                         const cities = excelData
                              ...
                              .map(
                                   (row) =>
                                        row[8]?.charAt(0).toLowerCase() +
                                        row[8].slice(1).toLowerCase()
                         ...
                         const qualifications = excelData
                              .slice(1) // Skip the header row
                              .map((row) => {
                                   const qualificationData = String(row[16]);
                                   return qualificationData.trim();
                              }); // Convert to lowercase
                         ...
                         const maritalStatuses = excelData
                              ...
                              .map((row) =>
                                   (
                                        row[10].charAt(0).toLowerCase() +
                                        row[10].slice(1).toLowerCase()
                                   ).trim()
                              ); // Convert to lowercase
     ...
     const handleSubmit = () => {
          const outputData = excelData.filter((data) => {
               ...
               console.log(data, qualification, "qualificationqualification");
               return (
                    ...
                    (!maritalStatus?.length ||
                         maritalStatus.includes(data.maritalStatus))
               );
          });
                                   ...
                                   <div className="filter-box-container">
                                        <div className="filter-options-container">
                                             ...
                                             <div className="qualification-wrapper">
                                                  ...
                                                  >
                                                       {formattedQualificationValues.map(
                                                            (
                                                                 qualificationObj
                                                            ) => (
                                                                 <MenuItem
                                                                      key={
                                                                           qualificationObj.value
                                                                      }
                                                                      value={
                                                                           qualificationObj.value
                                                                      }
                                        ...
                                        <p className="submit-notice-msg">
                                             please wait 3 - 5 seconds for your
                                             request to be processed after
                                             submitting.
                                        </p>
                                        ...
                                        <div className="TeamHeading">
                                             <div className="social_team">
                                                  <div className="team-label-wrapper">
                                                       <p className="team_label">
                                                            Social Team
                                                       </p>
                                                       <img
                                                            src={socialTeamIcon}
                                                            className="social-team-img"
                                                       />
                                                  </div>
